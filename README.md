...
**Final Gold dataset:** 113,320 rows · Fraud rate 11.76% · Saved as `gold.parquet` and `gold.csv`
...
1. Install dependencies using:
pip install -r requirements.txt 
Refer : requiremts.txt file for the dependies used....
...
4. Run the scoring script to test predictions:
